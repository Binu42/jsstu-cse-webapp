        ...
        <div className="container">
          ...
          <div className="row dev-list text-center" style={{ padding: "10px" }}>
            ...
            >
              <div className="widget clearfix">
                <img
                  src="https://jssstuniv.in/wp-content/uploads/2018/11/MPP-Picture-500x500.jpg"
                  alt=""
                ...
                <p>
                  ...
                  director and founder of Violetta.
                </p>
          ...
          <div className="row dev-list text-center" style={{ padding: "10px" }}>
            ...
            >
              <div className="widget clearfix">
                <img
                  src="https://jssstuniv.in/wp-content/uploads/2017/05/HDN.png"
                  alt=""
                  className="img-fluid rounded-circle"
                />
                <div className="widget-title">
